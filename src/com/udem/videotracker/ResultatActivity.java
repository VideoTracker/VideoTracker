...
public class ResultatActivity extends Activity {
	...
	public boolean onOptionsItemSelected (MenuItem item)
	{
	  ...
	  switch(item.getItemId())
	  {
	    case R.id.menu_playlist:
	    	intent = new Intent(ResultatActivity.this,
	...
	private class DownloadLoginTask extends AsyncTask<String, String, YoutubeAPI> {
		/*
		...
		protected void onPostExecute(YoutubeAPI web) {
			...
			if( web == null ) {
				Toast.makeText(ResultatActivity.this, "erreur fatale", Toast.LENGTH_SHORT).show();
				return;
			}
			
			if( web.erreur != null ) {
				Toast.makeText(ResultatActivity.this, web.erreur, Toast.LENGTH_SHORT).show();
				return;
			}
